            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-8 relative z-10">
                ...
                <div className="text-center mb-16 max-w-3xl mx-auto">
                    ...
                    <p className="text-lg text-slate-400 leading-relaxed">
                        Voltmax Power Solution manages the entire design, installation, and commissioning of your solar power plants. We ensure technically qualified professionals handle your investment in Bettiah and across India.
                    </p>
                </div>
